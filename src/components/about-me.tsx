  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-center mt-8 leading-9 dark:text-white/60">
        ...
        the privilege of working at some exciting startups and a
        design agency, where I&#39;ve worn many hats—from{" "}
        <em>coding</em> and <em>UX design</em> to <em>QA</em> and{" "}
        <em>product strategy</em>. When I&#39;m not deep in the world
        of tech, I love diving into content about{" "}
